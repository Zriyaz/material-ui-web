		  ...
		  >
			<Grid item style={{ marginLeft: matchesSM ? 0 : "5em", textAlign : matchesSM ? "center" : "inherit"}}  >
				<Grid container direction="column">
					<Grid item>
						<Typography variant="h2" >Simple Software.<br />Revolutionary Resukts</Typography>
						<Typography style={{fontSize: "1.5rem"}} variant="subtitle2">Take advantage of 21st Century.</Typography>
					</Grid>
